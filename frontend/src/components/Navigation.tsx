      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center space-x-6">
          <Link href="/dashboard" className="flex items-center space-x-2.5">
            ...
            <div>
              <span className="text-base font-bold tracking-tight text-white">OPS PILOT</span>
              <span className="ml-2 text-xs font-semibold text-blue-400">AI PLATFORM</span>
            </div>
          </Link>

          <div className="hidden md:flex items-center space-x-1.5 rounded-full border border-slate-800 bg-slate-900/80 px-3 py-1 text-xs text-slate-300">
            <Building2 className="h-3.5 w-3.5 text-blue-400" />
            <span className="font-medium text-slate-200">Demo Operations</span>
        ...
        <div className="flex items-center space-x-4">
          <button
            ...
            className="flex items-center space-x-1.5 rounded-md border border-slate-800 bg-slate-900 px-3 py-1.5 text-xs font-medium text-slate-400 hover:border-slate-700 hover:text-slate-200"
          >
